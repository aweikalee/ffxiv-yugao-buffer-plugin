  ...
  if (wsUrl) {
    ...
    function connectWs() {
      ...
      ws.addEventListener("open", () => {
        ...
        for (let msg of q) sendMessage(msg)
      })
    ...
    sendMessage = (obj, cb) => {
      if (queue) queue.push([obj, cb])
      else OverlayPluginApi.callHandler(JSON.stringify(obj), cb)
    }
    ...
    function waitForApi() {
      ...
      for (let [msg, resolve] of q) sendMessage(msg, resolve)
    }
